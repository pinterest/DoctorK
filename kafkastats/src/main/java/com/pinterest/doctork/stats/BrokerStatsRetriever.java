...
import com.pinterest.doctork.AvroTopicPartition;
import com.pinterest.doctork.BrokerError;
...
public class BrokerStatsRetriever {
  ...
  private static final String VERSION = "0.3.0-rc.3";
  ...
  public BrokerStats retrieveBrokerStats(String hostname, String jmxPort) throws Exception {
    ...
    // and have DoctorK service ignore these stats while computing the MaxIn/MaxOut stats
