...
class KafkaClusterTest {
  ...
  private static DoctorKClusterConfig doctorKClusterConfig;
  ...
  void getAlternativeBrokersDuplicateReassignmentTest() throws Exception {
    ...
    KafkaBroker[] brokers = new KafkaBroker[]{
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 0),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 1),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 2),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 3),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 4)
    };
  ...
  void testLocalityAwareReassignments() throws Exception {
    ...
    KafkaBroker[] brokers = new KafkaBroker[]{
        ...
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 3),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 4),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 5),
        new KafkaBroker(doctorKClusterConfig, spyKafkaCluster, 6)
    };
