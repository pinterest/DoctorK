...
public class DoctorKActionRetriever {

  private static final Logger LOG = LogManager.getLogger(com.pinterest.doctork.tools.DoctorKActionRetriever.class);
  ...
  private static CommandLine parseCommandLine(String[] args) {
    Option zookeeper = new Option(ZOOKEEPER, true, "doctork action zookeeper");
    Option topic = new Option(TOPIC, true, "doctork action topic");
