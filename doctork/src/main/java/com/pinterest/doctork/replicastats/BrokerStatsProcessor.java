...
import com.pinterest.doctork.DoctorKMetrics;
        ...
        for (ConsumerRecord<byte[], byte[]> record : records) {
          try {
            ...
            if (brokerStats == null || brokerStats.getName() == null) {
              ...
              OpenTsdbMetricConverter.incr(DoctorKMetrics.MESSAGE_DESERIALIZE_ERROR, 1);
              continue;
            }

            replicaStatsManager.update(brokerStats);
            OpenTsdbMetricConverter.incr(DoctorKMetrics.BROKERSTATS_MESSAGES, 1,
