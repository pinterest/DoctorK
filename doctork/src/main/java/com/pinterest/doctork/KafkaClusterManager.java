...
public class KafkaClusterManager implements Runnable {
  ...
  public KafkaClusterManager(String zkUrl,
    ...
    */
    ...
    evaluationFrequency = doctorkConfig.getEvaluationFrequency();

    this.taskEmitter = taskEmitter;
    this.taskDispatcher = taskDispatcher;

    loadPlugins(doctorkConfig, clusterConfig, pluginManager);
  ...
  protected void loadPlugins(DoctorKConfig doctorkConfig, DoctorKClusterConfig clusterConfig, PluginManager pluginManager) throws Exception {
    // load plugins
    loadMonitorPlugins(doctorkConfig, clusterConfig, pluginManager);
    loadOperatorPlugins(doctorkConfig, clusterConfig, pluginManager);
    loadActionPlugins(doctorkConfig, clusterConfig, pluginManager);
  }

  protected void loadMonitorPlugins(DoctorKConfig doctorkConfig, DoctorKClusterConfig clusterConfig, PluginManager pluginManager) throws Exception{
    Map<String, Configuration> baseMonitorsConfigs = doctorkConfig.getMonitorsConfigs();
  ...
  protected void loadOperatorPlugins(DoctorKConfig doctorkConfig, DoctorKClusterConfig clusterConfig, PluginManager pluginManager) throws Exception{
    Map<String, Configuration> baseOperatorsConfigs = doctorkConfig.getOperatorsConfigs();
  ...
  protected void loadActionPlugins(DoctorKConfig doctorkConfig, DoctorKClusterConfig clusterConfig, PluginManager pluginManager) throws Exception{
    Map<String, Configuration> baseActionsConfigs = doctorkConfig.getActionsConfigs();
