...
public class DoctorKActionsServlet extends DoctorKServlet {
  ...
  private static final Logger LOG = LogManager.getLogger(com.pinterest.doctork.servlet.DoctorKActionsServlet.class);
  ...
  private List<ConsumerRecord<byte[], byte[]>> retrieveActionReportMessages() throws IOException {
    DoctorKConfig doctorKConfig = com.pinterest.doctork.DoctorKMain.doctorK.getDoctorKConfig();
    String zkUrl = doctorKConfig.getActionReportZkurl();
    ...
    Properties properties =
        OperatorUtil.createKafkaConsumerProperties(zkUrl, OPERATOR_ACTIONS_CONSUMER_GROUP
            , doctorKConfig.getActionReportSecurityProtocol(), doctorKConfig.getActionReportConsumerConfig());
