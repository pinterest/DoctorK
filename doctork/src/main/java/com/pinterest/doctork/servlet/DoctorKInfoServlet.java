...
public class DoctorKInfoServlet extends DoctorKServlet {
  ...
  private static final Logger LOG = LogManager.getLogger(DoctorKInfoServlet.class);
  ...
  public void renderJSON(PrintWriter writer, Map<String, String> params) {
    ...
    Collection<KafkaClusterManager> clusterManagers = DoctorKMain.doctorK.getClusterManagers();
